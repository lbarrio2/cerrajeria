...
contactoForm.addEventListener('submit', (e) => {
    ...
    alert(`¡Gracias ${nombre}! Hemos recibido tu consulta. Nos pondremos en contacto pronto a ${telefono} o ${email}`);

    // Limpiar formulario
    contactoForm.reset();

    // Aquí podrías enviar los datos a un servidor
    // Opciones: Formspree, EmailJS, tu propio backend, Firebase, etc.
    console.log({
        nombre,
        email,
        telefono,
